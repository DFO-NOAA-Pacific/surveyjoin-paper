---
title: "Coastwide modeling of lingcod"
format: pdf
editor: visual
---
...
map_data <- rnaturalearth::ne_countries(
  scale = "medium",
  returnclass = "sf", country = c("united states of america","canada"))
coast <- suppressWarnings(suppressMessages(
  sf::st_crop(map_data,
    c(xmin = -179, ymin = 32, xmax = -114, ymax = 60))))
...
p1 <- ggplot(coast_proj) + 
  geom_point(data = pred, aes(X*1000,Y*1000, col = zeta_s_year_scaled1+zeta_s_year_scaled2+z1+z2),size=0.1) +
...
p2 <- ggplot(coast_proj) + 
  geom_point(data = pred, aes(X*1000,Y*1000, col = est_non_rf1 + omega_s1 + est_non_rf2 + omega_s2),size=0.1) +
